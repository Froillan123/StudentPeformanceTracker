    ...
    public async Task<ActionResult<IEnumerable<object>>> GetAllActive()
    {
        try
        {
            ...
            if (role == "Student")
            {
                ...
                announcements = await _announcementRepository.GetBySectionSubjectIdsAsync(sectionSubjectIds);
            }
    ...
    public async Task<ActionResult<object>> GetById(int id)
    {
        try
        {
            ...
            var result = new
            {
                ...
                TeacherName = announcement.Teacher != null ? $"{announcement.Teacher.FirstName} {announcement.Teacher.LastName}" : "Unknown",
                announcement.SectionSubjectId,
                SectionName = announcement.SectionSubject?.Section?.SectionName ?? "Unknown",
                SubjectName = announcement.SectionSubject?.Subject?.SubjectName ?? "Unknown",
                announcement.Title,
